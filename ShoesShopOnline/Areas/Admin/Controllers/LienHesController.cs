...
namespace ShoesShopOnline.Areas.Admin.Controllers
{
    public class LienHesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaLienHe,SDTLienHe,DiaChi,Email")] LienHe lienHe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaLienHe,SDTLienHe,DiaChi,Email")] LienHe lienHe)
        {
            if (ModelState.IsValid)
            {
